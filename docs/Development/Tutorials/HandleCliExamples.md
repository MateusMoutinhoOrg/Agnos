...
### Rules
- The script must follow its specification — locate it in [Specs.md](/docs/Development/References/Specs.md).
...
- Adding one requires updating [SamplesList.md](/docs/CliUsage/References/SamplesList.md) and [Structure.md](/docs/Development/References/Structure.md).
...
5. Make it executable and run it:
   ...
   bash ./examples/cliExamples/<Name>.sh
   ```
6. Add the script to [SamplesList.md](/docs/CliUsage/References/SamplesList.md).
7. Register it in [Structure.md](/docs/Development/References/Structure.md) if it introduces anything the schema does not already describe.
