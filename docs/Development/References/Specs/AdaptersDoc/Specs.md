...
- The page must not contain workflows — building an adapter is covered by [HandleAdapters.md](/docs/Development/Tutorials/HandleAdapters.md), which the page links to instead.

## Structure
1. **Title** (H1): `Adapters`.
2. **`## Description`**: one short paragraph on what the page lists, linking to [HandleAdapters.md](/docs/Development/Tutorials/HandleAdapters.md) for creating new adapters.
