...
### Rules
- Deleting a `.md` file requires updating the [README.md](/README.md) Doc Index and [Structure.md](/docs/Structure.md) in the same commit.
- Content still needed elsewhere must be moved before deletion, not lost — if the goal is to keep the content under another name, follow [RenameDocument.md](/docs/RenameDocument.md) instead.
