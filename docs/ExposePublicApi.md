...
## Description
Covers publishing a library function, object, or field in the public API index at [PublicApi.md](/docs/PublicApi.md) — the final step after adding it through [HandleLibElements.md](/docs/HandleLibElements.md).
