...
## Description
Covers adding one rule to the `verify` gate — a `check_*.go` file under `sandbox/internal/actions/verify/`. What the gate enforces today is [BuildPipeline.md](/docs/References/BuildPipeline.md#the-verify-gate).
...
- Adding a check requires updating the rule table of [BuildPipeline.md](/docs/References/BuildPipeline.md#the-verify-gate).
...
4. Register the rule in [BuildPipeline.md](/docs/References/BuildPipeline.md#the-verify-gate).
