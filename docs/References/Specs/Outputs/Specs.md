...
- `api.go` declares **types only** — never a function body. Every implementation lives in `sandbox/internal/`; see the [LibFunctions](/docs/References/Specs/LibFunctions/Specs.md) specification.
