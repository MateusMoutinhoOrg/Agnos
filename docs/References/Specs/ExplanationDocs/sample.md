...
Because `Deps` is a struct of function fields, the swap is an assignment, and every action downstream is silenced with it — see [StructContracts.md](/docs/References/StructContracts.md).
