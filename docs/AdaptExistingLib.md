...
10. Create the API detail pages (`docs/PublicApi/<pkg>.<Symbol>.md`) and rewrite `docs/PublicApi.md`, following [HandleLibElements.md](/docs/HandleLibElements.md#expose-in-the-public-api).
