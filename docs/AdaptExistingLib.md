...
8. Create the samples demonstrating the converted entry points: the Go programs in `libraryExamples/`, following [HandleSamples.md](/docs/HandleSamples.md), and the shell scripts in `cliExamples/`, following [HandleCliExamples.md](/docs/HandleCliExamples.md).
