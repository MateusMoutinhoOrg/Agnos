...
### [api.Lib](/docs/PublicApi/api.Lib.md)
...
### [lib.New](/docs/PublicApi/lib.New.md)
Injects a `deps.Deps` into the library and returns an `api.Lib`.

### [standard.New](/docs/PublicApi/standard.New.md)
...
The fields of [`api.Category`](/docs/PublicApi/api.Category.md) and [`api.Transaction`](/docs/PublicApi/api.Transaction.md) are documented on those structs' own pages; the entries below are the library functions `api.Lib` exposes.
...
### [api.Lib.GetCategory](/docs/PublicApi/api.GetCategory.md)
Returns the stored category with the given name, or `false` on a miss.

### [api.Lib.ListCategories](/docs/PublicApi/api.ListCategories.md)
Returns every stored category, oldest first.

### [api.Lib.AddSpend](/docs/PublicApi/api.AddSpend.md)
Records money leaving the budget under an existing category.

### [api.Lib.AddReceived](/docs/PublicApi/api.AddReceived.md)
Records money entering the budget under an existing category.

### [api.Lib.ListTransactions](/docs/PublicApi/api.ListTransactions.md)
Returns every transaction of every category.

### [api.Lib.Balance](/docs/PublicApi/api.Balance.md)
