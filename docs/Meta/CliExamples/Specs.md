...
- Adding, renaming, or deleting a CLI example requires updating the CLI Examples section of [README.md](/README.md) and [Structure.md](/docs/Structure.md) — see [AddCliExample.md](/docs/AddCliExample.md).
