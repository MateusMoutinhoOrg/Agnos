...
- It imports the library under the `agnos`-prefixed aliases every outside consumer uses; see the Import Aliases rule in [RULES.md](/docs/RULES.md).
...
- Renaming, moving, or adding an entry point requires updating [Structure.md](/docs/Structure.md) and the install command in the Quick Start CLI section of [README.md](/README.md).
