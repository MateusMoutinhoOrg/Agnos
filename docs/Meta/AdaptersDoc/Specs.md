...
## Structure
1. **Title** (H1): `Adapters`.
2. **`## Description`**: one short paragraph on what the page lists, linking to [HandleAdapters.md](/docs/HandleAdapters.md) for creating new adapters.
