...
- `sandbox/` is a closed sandbox: a factory must never import `adapters/`, `libraryExamples/`, a third-party module, or an OS-bound standard-library package (`os`, `net`, `syscall`, …). See [SandboxIsolation.md](/docs/SandboxIsolation.md).
