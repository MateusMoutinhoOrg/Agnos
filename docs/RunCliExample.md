...
## Description
Covers running the shell scripts in [cliExamples/](/cliExamples/), each of which builds the CLI and drives it the way a user would. Writing a new one is covered by [AddCliExample.md](/docs/AddCliExample.md); the Go programs that use the library from code instead are covered by [RunSample.md](/docs/RunSample.md).
