...
8. Create the samples demonstrating the converted entry points: the Go programs in `libraryExamples/`, following [AddSample.md](/docs/Tutorials/AddSample.md), and the shell scripts in `cliExamples/`, following [AddCliExample.md](/docs/Tutorials/AddCliExample.md).
