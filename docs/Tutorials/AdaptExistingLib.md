...
10. Create the API detail pages (`docs/References/PublicApi/<pkg>.<Symbol>.md`) and rewrite `docs/References/PublicApi.md`, following [HandleLibElements.md](/docs/Tutorials/HandleLibElements.md#expose-in-the-public-api).
