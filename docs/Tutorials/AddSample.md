...
## Description
Covers creating a runnable Go sample in [libraryExamples/](../../libraryExamples/) that demonstrates a library feature. The shell-script counterpart, demonstrating a feature against the built CLI, is covered by [AddCliExample.md](/docs/Tutorials/AddCliExample.md).

### Rules
- Creating a sample requires updating the Library Examples section of the [README.md](/README.md) and [Structure.md](/docs/References/Structure.md).
