...
6. Compile and verify the schema still holds:
   ...
   ```
7. Expose it on the command line following [AddAgnosCommand.md](/docs/Tutorials/AddAgnosCommand.md), and list it in the **Actions** section of [PublicApi.md](/docs/References/PublicApi.md) with a detail page — required by [HandleDocuments.md](/docs/Tutorials/HandleDocuments.md).
