...
9. Create the new samples: the Go programs in [libraryExamples/](../../libraryExamples/), following [AddSample.md](/docs/Tutorials/AddSample.md), and the shell scripts in [cliExamples/](../../cliExamples/), following [AddCliExample.md](/docs/Tutorials/AddCliExample.md).
