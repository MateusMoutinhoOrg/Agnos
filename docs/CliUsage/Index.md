...
| Doc | Description |
| --- | --- |
| [QuickStart.md](/docs/CliUsage/Protocols/QuickStart.md) | Install the binary and track a first budget in two steps |
| [InstallCli.md](/docs/CliUsage/Protocols/InstallCli.md) | Install the CLI globally, or build and run it from a checkout |
| [UseCli.md](/docs/CliUsage/Protocols/UseCli.md) | Create categories, record transactions, and read balances from the terminal |
