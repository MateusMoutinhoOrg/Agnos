...
## Description
Lists every file and directory of this template and the action it takes when the template becomes a new library — whether by forking ([ForkTemplate.md](/docs/Templating/Protocols/ForkTemplate.md)) or by adapting an existing library ([AdaptExistingLib.md](/docs/Templating/Protocols/AdaptExistingLib.md)). Each file falls into exactly one action:
...
| `docs/Templating/Protocols/ForkTemplate.md`, `docs/Templating/Protocols/AdaptExistingLib.md`, `docs/Templating/Protocols/RenameModule.md`, `docs/Templating/References/TemplateFileActions.md` | The template workflows and this page |
...
| `docs/Development/Protocols/HandleDependencies.md`, `docs/Development/Protocols/HandleLibElements.md`, `docs/Development/Protocols/HandleCliCommands.md`, `docs/Development/Protocols/HandleAdapters.md`, `docs/Development/Protocols/HandleSamples.md`, `docs/Development/Protocols/HandleCliExamples.md`, `docs/Development/Protocols/HandleDocuments.md` | The generic workflow guides for extending any library built on this structure |
...
| `docs/CliUsage/Protocols/QuickStart.md`, `docs/LibUsage/Protocols/QuickStart.md` | The new library's first-run walkthroughs, CLI and Go | TutorialDocs |
| `docs/CliUsage/Protocols/InstallCli.md`, `docs/CliUsage/Protocols/UseCli.md` | Installing and driving the new library's CLI | TutorialDocs |
| `docs/LibUsage/Protocols/LibInitialization.md` | Installing the new library and wiring its standard adapter | TutorialDocs |
| `docs/CliUsage/Protocols/RunCliSample.md`, `docs/LibUsage/Protocols/RunApiSample.md` | Running the new library's samples | TutorialDocs |
...
| `docs/<Theme>/Protocols/<Goal>.md` | One tutorial per workflow specific to the new library — the generic guides carried over by **[Copy](#copy)** do **not** fulfill this | TutorialDocs |
...
The template's example content — the financial tracker. Removed once the new library's own files exist. For `.md` files, follow [HandleDocuments.md](/docs/Development/Protocols/HandleDocuments.md) so the theme indexes stay in sync.
...
| `docs/LibUsage/Protocols/ManageCategories.md`, `docs/LibUsage/Protocols/TrackTransactions.md` | The tracker's domain tutorials |
