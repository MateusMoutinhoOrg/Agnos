...
11. Create the new API detail pages (`docs/PublicApi/<pkg>.<Symbol>.md`) and rewrite [PublicApi.md](/docs/PublicApi.md), following [ExposePublicApi.md](/docs/ExposePublicApi.md).
