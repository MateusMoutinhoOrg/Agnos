...
import (
	...
	keepadapter "github.com/MateusMoutinhoOrg/Agnos-Cli/Keep/adapters/native"
...
// Keep schema-database library, wired with Keep's own native adapter so its
// records live in memory too, copied onto the sandbox's local keepdeps.Lib.
// It returns a value rather than a closure because the field is a struct —
// see the Factories specification.
func KeepLibFactory(m *MemoryAdapter) keepdeps.Lib {
