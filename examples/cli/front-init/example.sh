...
# TestDir. sandbox/internal/routeslist/static proves the server layer came with it —
...
cp -R TestDir/sandbox/internal/routeslist/static/. AssertDir/sandbox/internal/routeslist/static/
