...
- The CLI version reported by `agnos-cli version` and `--version` is the content of `assets/version.txt`, read through `Deps.EmbedDeps`; it is independent of the `@v0.0.3` install tag pinned in `docs/Tutorials/CliQuickStart.md`, `docs/Tutorials/InstallCli.md`, `docs/Tutorials/LibQuickStart.md`, `docs/Tutorials/LibInitialization.md`, and `docs/References/Structure.md`. Bumping a release means touching both.
